...
internal class DatabaseConnection
{
        ...
        where T : class
    {
        ...
        var query = $"INSERT INTO {tableName} ({sqlColumns}) VALUES {sqlRows}";
        ...
        where T : class
    {
        ...
        foreach (var entity in modifiedEntities)
        {
            ...
            var query = $"UPDATE {tableName} SET {columnsSql} WHERE {primaryKeysSql}";
        ...
        where T : class
    {
        ...
        foreach (var entity in entitiesToDelete)
        {
            ...
            var query = $"DELETE FROM {tableName} WHERE {primaryKeysSql}";
